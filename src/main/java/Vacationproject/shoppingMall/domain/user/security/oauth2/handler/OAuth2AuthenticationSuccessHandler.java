...
import Vacationproject.shoppingMall.domain.user.security.oauth2.service.OAuth2UserPrincipal;
import Vacationproject.shoppingMall.domain.user.security.oauth2.user.OAuth2Provider;
import Vacationproject.shoppingMall.domain.user.security.oauth2.user.OAuth2UserUnlinkManager;
...
import static Vacationproject.shoppingMall.domain.user.security.oauth2.repository.HttpCookieOAuth2AuthorizationRequestRepository.MODE_PARAM_COOKIE_NAME;
